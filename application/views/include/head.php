...
<head>
    ...
    <meta name="author" content="mcseptian">
    <meta name="description" content="Presensi QR Code">
	...
	<script src="<?php echo base_url('assets/libraries/jquery/jquery-3.2.0.min.js'); ?>"></script>
