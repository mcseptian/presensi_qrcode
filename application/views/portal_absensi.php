...
?>
    ...
    <div class="title_portal_absensi">
        <span class="title1">Portal Presensi QR Code</span>
        <span class="title2">
		Pertemuan <span class="bold"> kelompok <span
                    id="pertemuan_kelompok"><?php echo $this->session->userdata("kelompok"); ?></span></span>,
		pada <span class="bold"
                   id="tanggal"><?php echo str_replace($date_eng, $date_ind, date('D, d M Y', $this->session->userdata("waktu"))); ?></span>
	</span>
    </div>

    <div id="container_absen">
        <div id="content_mulai_absen">
            <div id="btn_untuk_absen" onclick="mulai_absen()">Klik untuk Presensi</div>
            <div class="catatan_untuk_absen">Siapkan <span class="bold">kartu identitas</span> Anda</div>
        </div>
    ...
    <div id="btn_tutup_absen" onclick="tutup_absensi()">Tutup</div>
